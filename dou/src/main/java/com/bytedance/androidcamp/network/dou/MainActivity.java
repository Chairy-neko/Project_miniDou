            ...
            public void onResponse(Call<GetVideosResponse> call, Response<GetVideosResponse> response) {
                if (response.body() != null && response.body().videos != null) {
                    ...
                    for(int i = 0; i < response.body().videos.size();i++) {
                        ...
                        if(getString(R.string.refresh_my).equals(s)){
                            if (v.studentId.equals("17396876307") && v.userName.equals("neko")) {
                                mVideos.add(v);
                            }
                            mBtnRefresh.setText(R.string.refresh_all);
                        }else if(getString(R.string.refresh_all).equals(s)){
                            mVideos = response.body().videos;
                            mBtnRefresh.setText(R.string.refresh_my);
                        }
                    }
